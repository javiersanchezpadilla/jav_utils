""" Demos del uso de la librería FPDF
    para crear y manipular documentos PDF.
    Este script crea un PDF simple con un título y texto.
...
pdf.cell(200, 10, 'Título del PDF', ln=True, align='C')
